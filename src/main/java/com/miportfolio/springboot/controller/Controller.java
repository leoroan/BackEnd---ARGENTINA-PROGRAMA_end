...
import com.miportfolio.springboot.services.autorizacionServ.IAutorizacionService;
...
public class Controller {
    ...
    @Autowired
    private IAutorizacionService authServ;
    ...
    @GetMapping("/ver/autorizaciones")
    @ResponseBody
    public List<Autorizacion> traerAutorizacion() {
        return authServ.verAutorizaciones();
    }

    @PostMapping("/nueva/autorizacion")
    public void crearAutorizacion(@RequestBody Autorizacion aut) {
        authServ.crearAutorizacion(aut);
    }

    @DeleteMapping("/borrar/autorizacion/{id}")
    public void borrarAutorizacion(@PathVariable int id) {
        authServ.borrarAutorizacion(id);
    }
